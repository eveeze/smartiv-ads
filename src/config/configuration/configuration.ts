...
export const validationSchema = Joi.object({
  ...
  JWT_EXPIRES_IN: Joi.string().default('1d'), // Sesuai dengan .env baru
  ...
  // [NEW] Midtrans Validation (Sebelumnya hilang)
...
export default () => ({
  ...
  minio: {
    ...
    // Logic fallback cerdas untuk Public URL
    publicUrl:
